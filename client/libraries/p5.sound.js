...
soundfile = function () {
  ...
  */
   ...
   *
   *  The process involves running the soundfile through a  filter, and finding all of the
  ...
  p5.SoundFile.prototype.processPeaks = function (callback, _initThreshold, _minThreshold, _minPeaks) {
    ...
    filter.type = 'lowpass';
    source.connect(filter);                    //inline
    filter.connect(offlineContext.destination);//effect
...
filter = function () {
  ...
  p5.Filter.prototype.freq = function (freq, time) {
    ...
    if (typeof freq === 'number') {
      ...
      this.biquad.frequency.cancelScheduledValues(this.ac.currentTime);
